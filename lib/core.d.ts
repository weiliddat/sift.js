...
export declare abstract class NamedGroupOperation
...
export declare const containsOperation: (
  query: any,
  options: Options,
) => boolean;
export declare const createQueryOperation: <TItem, TSchema = TItem>(
  query: Query<TSchema>,
  owneryQuery?: any,
  { compare, operations }?: Partial<Options>,
) => QueryOperation<TItem>;
export declare const createOperationTester: <TItem>(
  operation: Operation<TItem>,
) => (item: TItem, key?: Key, owner?: any) => boolean;
export declare const createQueryTester: <TItem, TSchema = TItem>(
  query: Query<TSchema>,
