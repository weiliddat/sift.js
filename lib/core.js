...
const walkKeyPathValues = (item, keyPath, next, depth, key, owner) => {
  ...
  // { $eq: [1, 2, 3] }, [ 1, 2, 3 ].
  if (
    (0, utils_1.isArray)(item) &&
    isNaN(Number(currentKey)) &&
    !(0, utils_1.isProperty)(item, currentKey)
  ) {
...
const createEqualsOperation = (params, owneryQuery, options) =>
  new EqualsOperation(params, owneryQuery, options);
exports.createEqualsOperation = createEqualsOperation;
const numericalOperationCreator =
  (createNumericalOperation) => (params, owneryQuery, options, name) => {
    return createNumericalOperation(params, owneryQuery, options, name);
  };
exports.numericalOperationCreator = numericalOperationCreator;
const numericalOperation = (createTester) =>
  (0, exports.numericalOperationCreator)(
    (params, owneryQuery, options, name) => {
      ...
      return new EqualsOperation(
        (b) => {
          ...
          return (
            typeof (0, utils_1.comparable)(actualValue) === typeofParams &&
            test(actualValue)
          );
        },
        owneryQuery,
...
const createQueryTester = (query, options = {}) => {
  return (0, exports.createOperationTester)(
    (0, exports.createQueryOperation)(query, null, options),
  );
};
